...
export default function EnrollmentReport() {
  ...
  const stats = [
    ...
    { label: 'Total Questions', value: '9', icon: '❓', color: 'bg-pink-100' },
  ]
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-4">
        ...
        {/* Chart Placeholder - Enrollment Trend */}
        <div className="h-64 bg-gray-50 rounded-lg border border-gray-200 flex items-end justify-center gap-1 p-4">
          <div className="flex-1 h-4 bg-blue-400 rounded-t"></div>
          <div className="flex-1 h-6 bg-blue-400 rounded-t"></div>
          <div className="flex-1 h-8 bg-blue-400 rounded-t"></div>
          <div className="flex-1 h-10 bg-blue-400 rounded-t"></div>
          ...
          <div className="flex-1 h-40 bg-blue-400 rounded-t"></div>
        </div>
      </div>
